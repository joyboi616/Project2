...
namespace Project2.Controllers
{
    public class MusicsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Musics.Include(m => m.User);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var music = await _context.Musics
                .Include(m => m.User)
                .FirstOrDefaultAsync(m => m.FavArtistId == id);
            if (music == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("FavArtistId,FavArtistName,FavSongName,FavAlbumName,FavMusicVideoName,UserId")] Music music)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.Users, "UserId", "UserId", music.UserId);
            return View(music);
        }
        ...
        public async Task<IActionResult> Edit(int id, [Bind("FavArtistId,FavArtistName,FavSongName,FavAlbumName,FavMusicVideoName,UserId")] Music music)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!MusicExists(music.FavArtistId))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Musics.Any(e => e.FavArtistId == id);
        }
    }
}
